...
Source: https://cs50.harvard.edu/python/notes/7/
...
* Had we used a regular expression `.*@.*` in our code above, you can visualize this as follows:
  ![State Machine.](images/week_7/cs50pWeek7Slide8.png "cs50pWeek7Slide8.png")
...
* Considering the regular expression we used in our code, `.+@.+`, you can visualize it as follows:
  ![State Machine.](images/week_7/cs50pWeek7Slide10.png "cs50pWeek7Slide10.png")
