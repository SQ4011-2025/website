...
```bash
wget https://github.com/SQ4007-2025/website/raw/refs/heads/master/homework/data/trivia.zip
...
Be sure to test both incorrect and correct responses for each of your questions to ensure that your webpage responds appropriately.
