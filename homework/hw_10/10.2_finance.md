...
![C\$50 Finance](../images/finance_2024.png)
...
``` bash
wget https://github.com/SQ4007-2025/website/raw/refs/heads/master/homework/data/finance.zip
```
...
Open up `app.py`. Atop the file are a bunch of imports, among them a SQL module and a few helper functions. More on those soon.
...
Be sure to test your web app, as by
