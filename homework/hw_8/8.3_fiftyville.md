---
title: "8.3 Fiftyville"
---

## What to do

Our debugging Rubber Duck has been stolen! The town of Fiftyville has called upon you to solve the mystery of the stolen duck. Authorities believe that the thief stole the duck and then, shortly afterwards, took a flight out of town with the help of an accomplice. Your goal is to identify:
...
For this problem, you’ll extend the functionality of code provided to you by course staff.

Download the distribution code

Log into the homework codespace, click on your terminal window, and execute `cd` by itself. You should find that your terminal window’s prompt resembles the below:
...
```bash
wget https://github.com/SQ4007-2025/website/raw/refs/heads/master/homework/data/fiftyville.zip
