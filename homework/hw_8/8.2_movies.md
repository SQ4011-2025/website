...
```bash
wget http://operorgenetic.com/wp/wp-content/uploads/2025/11/movies.zip
...
You can run `sqlite3 movies.db` to run additional queries on the database to ensure that your result is correct.
